...
func _ready():
	...
	#m_panel.get_theme_stylebox("panel").bg_color = GameSettings.MENU_PANEL_COLOR
	...
	Logger.log_debug("SettingsMenu: Ready")


func on_return_button_pressed():
	emit_signal("POPUP_SETTINGS_CLOSE")
	#queue_free()
